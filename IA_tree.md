...
- CSV includes photo_paths values that point to files inside the ZIP (photos\building_name\...).
...
- CSV export includes photo_paths (semicolon-delimited) when photos exist.
